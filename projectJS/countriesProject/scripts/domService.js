...
import { saveLikedCountries, getLikedCountries } from "./likesCountries.js";
...
const generateCard = (country) => {
    ...
    heartIcon.addEventListener('click', () => {
        ...
        let likedCounties = getLikedCountries();
        const countryName = country.name.common;

        if (likedCounties.includes(countryName)) {
            likedCounties = likedCounties.filter(country => country !== countryName)
        } else {
            likedCounties.push(countryName);
        }
        saveLikedCountries(likedCounties);
    });
